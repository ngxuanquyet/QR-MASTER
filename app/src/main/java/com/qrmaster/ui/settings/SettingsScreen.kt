...
import com.qrmaster.utils.ShareUtils
...
fun SettingsScreen(
    ...
    val vibrateState = viewModel.isVibrate.collectAsState()
    val beepState = viewModel.isBeep.collectAsState()
            ...
            Column(
                ...
                Column(
                    ...
                    SettingItem(
                        ...
                        showSwitch = true,
                        switchChecked = vibrateState.value,
                        onSwitchChange = { viewModel.toggleVibrate() }
                    )
                    ...
                    SettingItem(
                        ...
                        showSwitch = true,
                        switchChecked = beepState.value,
                        onSwitchChange = { viewModel.toggleBeep() }
                    )
                }
